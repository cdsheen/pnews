...
$strHTTPlogoutInfo     = 'Chiudi tutte le finestre del tuo browser per evitare accessi non autorizzati.';
...
$strTime               = 'Ora';
$strAction             = 'Azione';
$strReceiver           = 'Ricevuto da';
$strName               = 'Nome';
$strEmail              = 'E-Mail';
$strContent            = 'Contenuto';
$strAttachment         = 'Allegato';

$strNoSubject          = '<nessun oggetto>';
...
$strCloseWindow        = 'Chiudi';

$strShowHeader         = 'Mostra intestazioni';

$strFirstPage          = 'Primo';
$strLastPage           = 'Ultimo';
$strNextPage           = 'Prossimo';
$strPreviousPage       = 'Precedente';

$strNextArticle        = 'Prossimo';
$strLastArticle        = 'Precedente'; 

$strPageNumber         = 'Pagina %s su un totale di %s pagine(a)';

$strReturnToGroupList  = 'Lista gruppi';
$strReturnToIndexing   = 'Lista articoli';
...
$strFormCancelPost     = 'Annulla';

$strFormConfirmDelete  = 'Cancella';
$strFormCancelDelete   = 'Annulla';

$strFormConfirmForward = 'Inoltra';
$strFormCancelForward  = 'Annulla';

$strFormInsertQuote    = 'Copia il testo';

$strPleaseEnterName    = 'Inserisci il tuo nome!';
